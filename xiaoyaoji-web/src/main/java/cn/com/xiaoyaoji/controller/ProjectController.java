...
import cn.com.xiaoyaoji.service.*;
...
public class ProjectController {
    ...
    public Object create(User user, Project project) {
        ...
        int rs = 0;
        if(project.getPermission().equals(Project.Permission.PUBLIC)) {
            rs = ProjectService.instance().createProject(project, UserService.instance
                    ().getAll());
        }
        else{
            rs = ProjectService.instance().createProject(project);
        }
